...
export default function MarketsPage() {
  ...
  const selectedMarket = data.find((v) => v.id === marketId);

  return (
    <AppShell>
      <AppShell.Header component={NavMT} />
      <AppShell.Main style={{ backgroundColor: "#fefbf6" }}>
          ...
          {selectedMarket ? (
            <>
              ...
              >
                <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="lg" mb="lg">
                  <Card style={cardStyle}>
                    ...
                    <Text>
                      <strong>Phone:</strong>{" "}
                      {selectedMarket.contact?.phone || "Not available"}
                    </Text>
                    <Text>
                      <strong>Email:</strong>{" "}
                      {selectedMarket.contact?.email || "Not available"}
                    </Text>
                  </Card>
                  <Card style={cardStyle}>
                    <Group align="center" mb="xs">
              ...
              >
                ...
                >
                  <Group align="center" mb="xs">
                    <Title order={4} c="#f26522" m={0}>
                      Events
                    </Title>
                  </Group>
                  <Text size="sm">
                    {selectedMarket.events || "No upcoming events listed."}
                  </Text>
                </Card>
              </motion.div>

              {/* Vendors with link to /vendors?vendorId=X */}
              <motion.div
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
              ...
              >
                <Card style={cardStyle}>
                  ...
                  {Array.isArray(selectedMarket.vendors) &&
                  selectedMarket.vendors.length > 0 ? (
            ...
            <>
              {/* All Markets Listing */}
              <Title order={1} mb="xl" c="#1f4d2e" fw={800}>
                Explore All Markets
              </Title>
