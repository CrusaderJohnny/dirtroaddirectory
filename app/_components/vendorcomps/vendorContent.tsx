...
import vendorList from '../../_res/vendors.json'; // Your vendor data
import VendorCard from '@/app/_components/vendorcomps/vendorcard';

export default function VendorsContent() { // Renamed from VendorsPage
    ...
    if (selectedVendor) {
        return (
            <AppShellMain style={{ backgroundColor: '#f7f5f2', minHeight: '100vh' }}>
